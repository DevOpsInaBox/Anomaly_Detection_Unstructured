...
print("*************************************Handling another prostate data part from CSV file**********************************")
print("First few rows of data from CSV file")
pros_csv<-read.csv("prostate_unstructured.csv",header = T)
head(pros_csv)
print("**********************Handling another prostate data part from TXT file having hexadecimal values***********************")
print("First few rows of hexadeximal data from TXT file")
pros_txt<-read.table("prostate_hex.txt",header = T)
head(pros_txt)
print("*********************Converting the prostate data part having hexadecimal columns to decimal values**********************")
